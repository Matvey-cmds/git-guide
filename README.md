...
8. `git checkout branch-name` - переключится на ветку, пример:<img width="446" height="71" alt="10" src="https://github.com/user-attachments/assets/6229da87-a203-497d-811f-c68c0aad32b5" />
...
2. `git remote add origin <url>` - подключить удалённый репозиторий, пример:<img width="604" height="42" alt="13" src="https://github.com/user-attachments/assets/6a7af874-088a-4067-9af7-9a243b3cd3ea" />
