...
6. `git log` - История коммитов, пример:<img width="513" height="63" alt="8" src="https://github.com/user-attachments/assets/661db7f7-265b-4b1a-807e-7c13eace1f0c" />
   6.1. `git log --oneline` — короткая история \
   6.2.  `git log --oneline -5` — только 5 последних коммитов \
   6.3.  `git log --graph ` — дерево всех веток, пример: <img width="737" height="107" alt="22" src="https://github.com/user-attachments/assets/ea52a6f3-d846-44ef-99c1-c96988d2c642" /> 
8. `git version` - проверка веврсии установленного Git, пример: <img width="446" height="58" alt="26" src="https://github.com/user-attachments/assets/0c5d40e7-cfb3-493d-9a4b-1df1623f09ff" />
...
6. Владелец решает принять ли изменения или отказать в них, если владелец согласен то он нажимает Compare&pull
